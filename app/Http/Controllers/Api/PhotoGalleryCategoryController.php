...
class PhotoGalleryCategoryController extends Controller
{
    ...
    {
        $query = PhotoGalleryCategory::active();
        ...
        return response()->json([
            'success' => true,
            'data' => $categories,
            'message' => 'Photo gallery categories retrieved successfully'
        ]);
    }
    ...
    {
        $category = PhotoGalleryCategory::with(['parent', 'children', 'galleries', 'menu'])
            ->find($id);
    ...
    {
        $categories = PhotoGalleryCategory::active()
            ->main()
            ->with(['children'])
            ->orderBy('cat_pos', 'asc')
            ->get();

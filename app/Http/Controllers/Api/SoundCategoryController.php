...
class SoundCategoryController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        return response()->json([
            'success' => true,
            'data' => $categories,
            'message' => 'Sound categories retrieved successfully'
        ]);
    }
    ...
    {
        $category = SoundCategory::with(['parent', 'children', 'sounds', 'menu'])
            ->find($id);
    ...
    {
        $categories = SoundCategory::active()
            ->main()
            ->with(['children'])
            ->orderBy('cat_pos', 'asc')
            ->get();

...
{
    protected $table = 'st_book_category';
    ...
    {
        return $this->belongsTo(BookCategory::class, 'cat_father_id', 'cat_id');
    }

    public function children()
    {
        return $this->hasMany(BookCategory::class, 'cat_father_id', 'cat_id');
    }

    // Relationship with books
    public function books()
    {
        return $this->hasMany(Book::class, 'book_cat_id', 'cat_id');
    }

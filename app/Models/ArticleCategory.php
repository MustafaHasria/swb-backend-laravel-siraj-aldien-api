...
{
    protected $table = 'st_article_category';
    ...
    {
        return $this->belongsTo(ArticleCategory::class, 'cat_father_id', 'cat_id');
    }

    public function children()
    {
        return $this->hasMany(ArticleCategory::class, 'cat_father_id', 'cat_id');
    }

    // Relationship with articles
    public function articles()
    {
        return $this->hasMany(Article::class, 'article_cat_id', 'cat_id');
    }

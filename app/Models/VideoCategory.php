...
{
    protected $table = 'st_video_category';
    ...
    {
        return $this->belongsTo(VideoCategory::class, 'cat_father_id', 'cat_id');
    }

    public function children()
    {
        return $this->hasMany(VideoCategory::class, 'cat_father_id', 'cat_id');
    }

    // Relationship with videos
    public function videos()
    {
        return $this->hasMany(Video::class, 'video_cat_id', 'cat_id');
    }

...
{
    protected $table = 'st_sound_category';
    ...
    {
        return $this->belongsTo(SoundCategory::class, 'cat_father_id', 'cat_id');
    }

    public function children()
    {
        return $this->hasMany(SoundCategory::class, 'cat_father_id', 'cat_id');
    }

    // Relationship with sounds
    public function sounds()
    {
        return $this->hasMany(Sound::class, 'sound_cat_id', 'cat_id');
    }
